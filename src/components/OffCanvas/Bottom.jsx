...
const OffCanvasBottom = ({
    ...
    return (
        <>
            ...
            <div className={`flex w-full h-screen transition-all fixed bottom-0 right-0 delay-500 ${!open ? " translate-y-[100%]" : "translate-y-0"}`}>
                <div className="h-[20rem] w-full mt-auto bg-white rounded-t-xl overflow-hidden">
