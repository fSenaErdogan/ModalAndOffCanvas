...
const OffCanvasEnd = ({
    ...
    return (
        <>
            ...
            <div className={`w-full h-screen transition-all fixed top-0 right-0 delay-500 translate-x- ${!open ? " translate-x-[100%]" : "translate-x-0"}`}>
                <div className="w-[30rem] bg-white h-screen rounded-s-xl overflow-hidden ms-auto">
